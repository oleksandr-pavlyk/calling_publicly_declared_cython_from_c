all:
	...
	c++ -g -O2 -c rect.cpp -o rect.o -I`python3-config --includes` -I`python3 -c "import numpy as np; print(np.get_include())"`
	c++ -g -O2 -c Rectangle.cpp -o Rectangle.o -I`python3-config --includes`
	c++ -g -O2 -c main.cpp -o main.o -I`python3-config --includes` -I`python3 -c "import numpy as np; print(np.get_include())"`
